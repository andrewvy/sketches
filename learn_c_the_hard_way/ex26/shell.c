...
int Shell_exec(Shell template, ...) {
  ...
  check(template.argc == template_args, "Wrong number of arguments passed to Shell_exec");
...
Shell AUTO_GEN_SH = {
  .exe = "./autogen.sh",
  .dir = "/tmp/pkg-build",
  .args = { "autogen.sh", NULL },
  .argc = 0
};

Shell AUTO_CONFIGURE_SH = {
  .exe = "auto-reconf",
  .dir = "/tmp/pkg-build",
  .args = { "autoreconf", "-i", NULL },
  .argc = 0
};
